...
class BankSoalResume extends StatefulWidget {
  int idSession;
  BankSoalResume({Key? key, required this.idSession}) : super(key: key);

  @override
  State<BankSoalResume> createState() => _BankSoalResumeState();
}

class _BankSoalResumeState extends State<BankSoalResume> {
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Obx(
                                    () => Expanded(
                                      child: Text(
                                          _bankSoalController.judulTryout.value
                                              .toUpperCase(),
                                          softWrap: true,
                            ...
                            Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Obx(
                                    () => Text(
                                        _bankSoalController.tanggalTryout.value
                                            .toString(),
                                        style: const TextStyle(
                                            fontFamily: 'Poppins',
                                            fontWeight: FontWeight.w700,
                            ...
                            Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Obx(
                                    () => Text(
                                        _bankSoalController.tryoutDijawab.value
                                            .toString(),
                                        style: const TextStyle(
                                            fontFamily: 'Poppins',
                                            fontWeight: FontWeight.w700,
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Obx(
                                    () => Expanded(
                                      child: Text(
                                          _bankSoalController.tryoutLewat.value
                                              .toString(),
                                          softWrap: true,
                                          textAlign: TextAlign.end,
                                          style: const TextStyle(
