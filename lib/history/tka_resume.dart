...
class TkaResume extends StatefulWidget {
  int idSession;
  TkaResume({super.key, required this.idSession});

  @override
  State<TkaResume> createState() => _TkaResumeState();
}

class _TkaResumeState extends State<TkaResume> {
                    ...
                    Container(
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          Get.to(
                            () =>
                                TkaDetail(jawabanList: controller.hasilList),
                          );
                        },
