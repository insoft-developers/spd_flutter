...
class BeritaDetail extends StatefulWidget {
  ...
  BeritaDetail({Key? key, required this.dataSlider}) : super(key: key);
      ...
      body: Container(
        ...
        child: ListView(
          children: [
            ClipRRect(
              ...
              child: CachedNetworkImage(
                  imageUrl: Contants.BASE_URL +
                      ...
                      widget.dataSlider['news_image'].toString()),
            ),
            const SizedBox(
              height: 10,
            ),
            Center(
              child: Text(widget.dataSlider['news_title'].toString(),
            ...
            Text(widget.dataSlider['news_content'].toString(),
                style: const TextStyle(
                  fontFamily: 'Poppins',
                  fontSize: 15,
                ))
