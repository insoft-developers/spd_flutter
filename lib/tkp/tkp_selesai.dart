...
class TkpSelesai extends StatefulWidget {
  int idSession;
  TkpSelesai({Key? key, required this.idSession}) : super(key: key);

  @override
  State<TkpSelesai> createState() => _TkpSelesaiState();
}

class _TkpSelesaiState extends State<TkpSelesai> {
                              ...
                              Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Obx(
                                      () => Text(
                                          _tkpController.tkpTarget.value
                                              .toString(),
                                          style: const TextStyle(
                                              fontFamily: 'Poppins',
                                              fontWeight: FontWeight.w700,
