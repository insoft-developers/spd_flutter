...
import 'package:Genzi/tkp/tkp_start.dart';
...
class TkpTertib extends StatefulWidget {
  Map<String, dynamic> dataList;
  TkpTertib({Key? key, required this.dataList}) : super(key: key);

  @override
  State<TkpTertib> createState() => _TkpTertibState();
}

class _TkpTertibState extends State<TkpTertib> {
  late int userId;
  ...
  _loadUserData() async {
    ...
    if (user != null) {
      userId = user['id'];
      _tkpController
          .createTkpSession(widget.dataList['id'], userId)
          .then((value) {
        Get.to(() => TkpStart(
                      ...
                      Container(
                        ...
                        child: Row(
                          ...
                          children: const [
                            ...
                            Expanded(
                              child: Text(
                                  "Pastikan Koneksi Anda stabil dan paket data anda cukup untuk mengikuti TKP ini. ",
                                  softWrap: true,
                                  style: TextStyle(
                      ...
                      Container(
                        ...
                        child: Row(
                          ...
                          children: const [
                            ...
                            Expanded(
                              child: Text(
                                  "Pastikan waktu anda cukup untuk menyelesaikan seluruh soal TKP. Jika tidak maka TKP akan selesai secara otomatis atau akan masuk ke TKP berikutnya. ",
                                  softWrap: true,
                                  style: TextStyle(
                                      fontFamily: 'PoppinsSemiBold',
                                      color: Colors.white)),
