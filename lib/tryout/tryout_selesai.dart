...
class TryoutSelesai extends StatefulWidget {
  int idSession;
  TryoutSelesai({Key? key, required this.idSession}) : super(key: key);

  @override
  State<TryoutSelesai> createState() => _TryoutSelesaiState();
}

class _TryoutSelesaiState extends State<TryoutSelesai> {
