...
import 'package:Genzi/tryout/tryout_start.dart';
...
class TryoutTertib extends StatefulWidget {
  Map<String, dynamic> dataList;
  TryoutTertib({Key? key, required this.dataList}) : super(key: key);

  @override
  State<TryoutTertib> createState() => _TryoutTertibState();
}

class _TryoutTertibState extends State<TryoutTertib> {
  late int userId;
  ...
  _loadUserData() async {
    ...
    if (user != null) {
      userId = user['id'];
      _tryoutController
          .createTryoutSession(widget.dataList['id'], userId)
          .then((value) {
        Get.to(() => TryoutStart(
          ...
          children: [
            Expanded(
              ...
              child: Column(children: [
                ...
                const Judul(judul: "Detail Try Out"),
