...
class TryoutReport extends StatefulWidget {
  int idSoal;
  String noSoal;
  String soal;
  int idSession;
  ...
  @override
  State<TryoutReport> createState() => _TryoutReportState();
}

class _TryoutReportState extends State<TryoutReport> {
          ...
          children: [
            ...
            Container(
                ...
                child: ElevatedButton(
                    onPressed: () {
                      // _tryoutController.resumeTimer(widget.idSession);
  ...
  saveReportConfirm(BuildContext context) {
    Widget continueButton = TextButton(
      ...
      onPressed: () {
        _tryoutController
            .tryoutReportAdd(widget.idSoal, widget.idUser,
                controllerReportText.text, "tryout")
            .then((value) {
          if (value) {
