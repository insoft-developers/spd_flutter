...
class TkaReport extends StatefulWidget {
  int idSoal;
  String noSoal;
  String soal;
  int idSession;
  ...
  @override
  State<TkaReport> createState() => _TkaReportState();
}

class _TkaReportState extends State<TkaReport> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Laporkan Soal")),
          ...
          children: [
            ...
            Container(
              ...
              child: ElevatedButton(
                onPressed: () {
                  // controller.resumeTimer(widget.idSession);
  ...
  saveReportConfirm(BuildContext context) {
    Widget continueButton = TextButton(
      child: const Text("Simpan", style: TextStyle(fontFamily: 'PoppinsBold')),
      onPressed: () {
        controller
            .reportAdd(
              widget.idSoal,
