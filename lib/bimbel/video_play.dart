...
class _VideoPlayState extends State<VideoPlay> {
  ...
  void dilihat() {
    _bimbinganController.fetchDilihat(widget.idBimbingan, userid);
  }

  void likePost() {
    _controller.pause();
    _bimbinganController.likePost("bimbingan", userid, widget.idBimbingan);
  }
  ...
  void fetchComment() {
    ...
    var result = _bimbinganController
        .fetchComment(widget.idBimbingan, 'bimbingan')
        .then((value) {
  ...
  void addComment(String isi) {
    if (isi.isNotEmpty) {
      ...
      var response = _bimbinganController
          .addComment(userid, 'bimbingan', widget.idBimbingan, isi)
          .then((value) {
        if (value['success']) {
